...
### Selecci'on GARCH(p,q) 'optimo

$Y_t = \mu_t+\varepsilon_t$

$h_t = \omega+\beta_ih^2_{t-i}+\alpha_i\varepsilon^2_{t-i}+u_t$
...
ggplot()+
  ...
  geom_line(aes(y = arch.fit@fit$sigma*(F_inv), x = tiempo), colour = 'red', alpha = 0.25) +

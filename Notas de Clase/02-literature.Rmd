...
Es facil ver que muchas de las posibilidades de realización de este proceso estocástico (series de tiempo) pueden tomar cualquiera de las rutas consideradas en el Figura \ref{Caminata}.
\begin{figure}
  \centering
    \includegraphics[width=0.7\textwidth]{Caminata}
  \caption{Ejemplo de 10 trayectorias de la caminata aleatoria, cuando sólo es posible cambios de +1 y -1}
  \label{Caminata}
\end{figure}
